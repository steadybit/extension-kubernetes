...
func getAbortDescription() action_kit_api.ActionDescription {
	...
	desc.Parameters = append(desc.Parameters,
		action_kit_api.ActionParameter{
			...
			Description:  new("The HTTP status code returned for aborted requests."),
		...
		action_kit_api.ActionParameter{
			Name:        "body",
			Label:       "Response Body",
			Description: new("Optional: the response body returned to clients for aborted requests. Leave empty to return an empty body."),
		...
		action_kit_api.ActionParameter{
			Name:         "contentType",
			Label:        "Content Type",
			Description:  new("The Content-Type header set on the overwritten response body."),
			Type:         action_kit_api.ActionParameterTypeString,
			DefaultValue: new("application/json"),
			Required:     new(false),
			Advanced:     new(true),
		},
	)
