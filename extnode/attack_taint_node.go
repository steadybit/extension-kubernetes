		...
		Parameters: []action_kit_api.ActionParameter{
			{
				...
				Description:  new("The duration of the action. The taint will be removed after the action."),
				Advanced:     new(false),
				Required:     new(true),
			...
			},
			{
				...
				Description: new("The key of the taint."),
				Advanced:    new(false),
				Required:    new(true),
				Order:       new(1),
			},
			{
				...
				Name:        "value",
				Type:        action_kit_api.ActionParameterTypeString,
				Description: new("The optional value of the taint."),
				Advanced:    new(false),
				Required:    new(false),
				Order:       new(1),
			},
			{
				...
				Name:         "effect",
				Type:         action_kit_api.ActionParameterTypeString,
				Description:  new("The effect of the taint."),
				Advanced:     new(false),
				Required:     new(true),
				DefaultValue: new("NoSchedule"),
				Order:        new(2),
