	...
	return advice_kit_api.AdviceDefinition{
		...
		Description: advice_kit_api.AdviceDefinitionDescription{
			ActionNeeded: advice_kit_api.AdviceDefinitionDescriptionActionNeeded{
				Instruction: readMarkDownFile("./extdeployment/advice_templates/deployment_strategy/instructions.md"),
				Motivation:  readMarkDownFile("./extdeployment/advice_templates/deployment_strategy/motivation.md"),
				Summary:     readMarkDownFile("./extdeployment/advice_templates/deployment_strategy/action_needed_summary.md"),
			},
			ValidationNeeded: advice_kit_api.AdviceDefinitionDescriptionValidationNeeded{
				Summary: readMarkDownFile("./extdeployment/advice_templates/deployment_strategy/validation_needed.md"),
			},
			Implemented: advice_kit_api.AdviceDefinitionDescriptionImplemented{
				Summary: readMarkDownFile("./extdeployment/advice_templates/deployment_strategy/implemented.md"),
			},
		},
	}
}
...
func getDeploymentAdviceDescriptionCPULimit() advice_kit_api.AdviceDefinition {
	return advice_kit_api.AdviceDefinition{
		Id:         DeploymentTargetType + ".advice.k8s-cpu-limit",
		Label:     "CPU Limit",
		Version:    extbuild.GetSemverVersionStringOrUnknown(),
		...
		AssessmentQueryApplicable: "target.type=\"" + DeploymentTargetType + "\"",
		AssessmentQueryActionNeeded: "k8s.deployment.advice.limit.cpu.not-set=\"true\"",
		Experiments: &[]advice_kit_api.Experiment{
			readMarkDownFile("./extdeployment/advice_templates/cpu_limit/experiment_cpu_limit.json"),
		},
		Description: advice_kit_api.AdviceDefinitionDescription{
			ActionNeeded:     advice_kit_api.AdviceDefinitionDescriptionActionNeeded{
				Instruction: readMarkDownFile("./extdeployment/advice_templates/cpu_limit/instructions.md"),
				Motivation:  readMarkDownFile("./extdeployment/advice_templates/cpu_limit/motivation.md"),
				Summary:     readMarkDownFile("./extdeployment/advice_templates/cpu_limit/action_needed_summary.md"),
			},
			ValidationNeeded: advice_kit_api.AdviceDefinitionDescriptionValidationNeeded{
				Summary: readMarkDownFile("./extdeployment/advice_templates/cpu_limit/validation_needed.md"),
			},
			Implemented:      advice_kit_api.AdviceDefinitionDescriptionImplemented{
				Summary: readMarkDownFile("./extdeployment/advice_templates/cpu_limit/implemented.md"),
			},
		},
	}
}
...
func readMarkDownFile(fileName string) string {
