package ephemeral_storage_limit
		...
		Status: advice_kit_api.AdviceDefinitionStatus{
			ActionNeeded: advice_kit_api.AdviceDefinitionStatusActionNeeded{
				...
				Description: advice_kit_api.AdviceDefinitionStatusActionNeededDescription{
					Instruction: advice_common.ReadAdviceFile(EphemeralStorageLimitContent, "instructions.md"),
					Motivation:  advice_common.ReadAdviceFile(EphemeralStorageLimitContent, "motivation.md"),
					Summary:     advice_common.ReadAdviceFile(EphemeralStorageLimitContent, "action_needed_summary.md"),
				},
			},
			Implemented: advice_kit_api.AdviceDefinitionStatusImplemented{
				Description: advice_kit_api.AdviceDefinitionStatusImplementedDescription{
					Summary: advice_common.ReadAdviceFile(EphemeralStorageLimitContent, "implemented.md"),
				},
			},
			ValidationNeeded: advice_kit_api.AdviceDefinitionStatusValidationNeeded{
				Description: advice_kit_api.AdviceDefinitionStatusValidationNeededDescription{
					Summary: advice_common.ReadAdviceFile(EphemeralStorageLimitContent, "validation_needed.md"),
				},
				Validation: extutil.Ptr([]advice_kit_api.Validation{
					{
						...
						ExperimentTemplate: extutil.Ptr(advice_kit_api.ExperimentTemplate(advice_common.ReadAdviceFile(EphemeralStorageLimitContent, "experiment_ephemeral_storage_limit.json.ftl"))),
					},
				}),
			},
		},
