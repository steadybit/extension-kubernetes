				...
				Validation: new([]advice_kit_api.Validation{
					{
						...
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(advice_common.ReadAdviceFile(EphemeralStorageLimitContent, "experiment_ephemeral_storage_limit.json.ftl"))),
					},
				}),
			},
		},
