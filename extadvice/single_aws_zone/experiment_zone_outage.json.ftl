{
  ...
  "tags": ["Redundancy", "AWS", "Availability Zone", "Advice"],
  "experimentName": "AWS Zone Outage of ${target.attr('aws.zone', 0)} for ${target.attr('steadybit.label')}",
