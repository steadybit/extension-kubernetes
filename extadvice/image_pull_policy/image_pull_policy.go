		...
		Status: advice_kit_api.AdviceDefinitionStatus{
			ActionNeeded: advice_kit_api.AdviceDefinitionStatusActionNeeded{
				...
				Description: advice_kit_api.AdviceDefinitionStatusActionNeededDescription{
					Instruction: advice_common.ReadAdviceFile(ImagePullPolicyContent, "instructions.md"),
					Motivation:  advice_common.ReadAdviceFile(ImagePullPolicyContent, "motivation.md"),
					Summary:     advice_common.ReadAdviceFile(ImagePullPolicyContent, "action_needed_summary.md"),
				},
			},
			Implemented: advice_kit_api.AdviceDefinitionStatusImplemented{
				Description: advice_kit_api.AdviceDefinitionStatusImplementedDescription{
					Summary: advice_common.ReadAdviceFile(ImagePullPolicyContent, "implemented.md"),
				},
			},
		},
	}
