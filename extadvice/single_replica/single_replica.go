...
func GetAdviceDescriptionSingleReplica() advice_kit_api.AdviceDefinition {
	return advice_kit_api.AdviceDefinition{
		...
		AssessmentQueryApplicable: "target.type=\"" + extdeployment.DeploymentTargetType + "\" AND k8s.specification.is-redundant IS PRESENT",
		Status: advice_kit_api.AdviceDefinitionStatus{
			ActionNeeded: advice_kit_api.AdviceDefinitionStatusActionNeeded{
				AssessmentQuery: "k8s.specification.is-redundant=\"false\"",
				Description: advice_kit_api.AdviceDefinitionStatusActionNeededDescription{
					Instruction: advice_common.ReadAdviceFile(SingleReplicaContent, "instructions.md"),
					Motivation:  advice_common.ReadAdviceFile(SingleReplicaContent, "motivation.md"),
					Summary:     advice_common.ReadAdviceFile(SingleReplicaContent, "action_needed_summary.md"),
				},
			},
			Implemented: advice_kit_api.AdviceDefinitionStatusImplemented{
				Description: advice_kit_api.AdviceDefinitionStatusImplementedDescription{
					Summary: advice_common.ReadAdviceFile(SingleReplicaContent, "implemented.md"),
				},
			},
			ValidationNeeded: advice_kit_api.AdviceDefinitionStatusValidationNeeded{
				Description: advice_kit_api.AdviceDefinitionStatusValidationNeededDescription{
					Summary: advice_common.ReadAdviceFile(SingleReplicaContent, "validation_needed.md"),
				},
				Validation: new([]advice_kit_api.Validation{
					{
						...
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(advice_common.ReadAdviceFile(SingleReplicaContent, "experiment_pod_failure.json.ftl"))),
					},
				}),
			},
		},
