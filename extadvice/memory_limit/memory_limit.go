		...
		Status: advice_kit_api.AdviceDefinitionStatus{
			ActionNeeded: advice_kit_api.AdviceDefinitionStatusActionNeeded{
				...
				Description: advice_kit_api.AdviceDefinitionStatusActionNeededDescription{
					Instruction: advice_common.ReadAdviceFile(MemoryLimitContent, "instructions.md"),
					Motivation:  advice_common.ReadAdviceFile(MemoryLimitContent, "motivation.md"),
					Summary:     advice_common.ReadAdviceFile(MemoryLimitContent, "action_needed_summary.md"),
				},
			},
			Implemented: advice_kit_api.AdviceDefinitionStatusImplemented{
				Description: advice_kit_api.AdviceDefinitionStatusImplementedDescription{
					Summary: advice_common.ReadAdviceFile(MemoryLimitContent, "implemented.md"),
				},
			},
			ValidationNeeded: advice_kit_api.AdviceDefinitionStatusValidationNeeded{
				Description: advice_kit_api.AdviceDefinitionStatusValidationNeededDescription{
					Summary: advice_common.ReadAdviceFile(MemoryLimitContent, "validation_needed.md"),
				},
				Validation: new([]advice_kit_api.Validation{
					{
						...
						ExperimentTemplate: new(advice_kit_api.ExperimentTemplate(advice_common.ReadAdviceFile(MemoryLimitContent, "experiment_memory_limit.json.ftl"))),
					},
				}),
			},
		},
