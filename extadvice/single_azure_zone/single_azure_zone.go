		...
		Status: advice_kit_api.AdviceDefinitionStatus{
			ActionNeeded: advice_kit_api.AdviceDefinitionStatusActionNeeded{
				...
				Description: advice_kit_api.AdviceDefinitionStatusActionNeededDescription{
					Instruction: advice_common.ReadAdviceFile(SingleAzureZoneContent, "instructions.md"),
					Motivation:  advice_common.ReadAdviceFile(SingleAzureZoneContent, "motivation.md"),
					Summary:     advice_common.ReadAdviceFile(SingleAzureZoneContent, "action_needed_summary.md"),
				},
			},
			Implemented: advice_kit_api.AdviceDefinitionStatusImplemented{
				Description: advice_kit_api.AdviceDefinitionStatusImplementedDescription{
					Summary: advice_common.ReadAdviceFile(SingleAzureZoneContent, "implemented.md"),
				},
			},
			ValidationNeeded: advice_kit_api.AdviceDefinitionStatusValidationNeeded{
				Description: advice_kit_api.AdviceDefinitionStatusValidationNeededDescription{
					Summary: advice_common.ReadAdviceFile(SingleAzureZoneContent, "validation_needed.md"),
				},
				Validation: extutil.Ptr([]advice_kit_api.Validation{
					{
						...
						Experiment:       extutil.Ptr(advice_kit_api.Experiment(advice_common.ReadAdviceFile(SingleAzureZoneContent, "experiment_zone_outage.json"))),
					},
				}),
			},
		},
